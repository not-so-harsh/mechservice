...
const Testimonial = ({
  ...
  const sectionHeader = {
    ...
    paragraph: 'What our clients are saying about us...'
  };
            ...
            <div className="tiles-item reveal-from-right" data-reveal-delay="200">
              <div className="tiles-item-inner">
                <div className="testimonial-item-content">
                  <p className="text-sm mb-0 txt-white">
                  I've been taking my vehicles to  for a number of years and have always had a good experience. Customer service is excellent and they live by the golden rule. Can't recommend them enough!                      </p>
                </div>
                <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
                  <span className="testimonial-item-name text-color-high">Laurie Anderson</span>
                  <span className="text-color-low"> / </span>
                  <span className="testimonial-item-link">
                    <a href="#0">MechService</a>
                  </span>
                </div>
              </div>
            </div>
